...
M_.param_names(7) = {'sigmaer'};
M_.param_names_tex(7) = {'sigmaer'};
M_.param_names_long(7) = {'sigmaer'};
...
M_.block_structure.equation_reordered = [ 3 2 1 7 8 4 6 5];
...
M_.dynamic_g1_sparse_rowval = int32([2 4 7 8 3 4 5 5 1 2 2 3 4 7 8 1 2 5 6 8 7 6 1 1 6 3 2 ]);
M_.dynamic_g1_sparse_colval = int32([3 3 3 3 4 9 9 10 11 11 12 12 12 12 12 13 13 13 13 14 15 16 20 21 21 25 26 ]);
M_.dynamic_g1_sparse_colptr = int32([1 1 1 5 6 6 6 6 6 8 9 11 16 20 21 22 23 23 23 23 24 26 26 26 26 27 28 ]);
M_.lhs = {
'exp(c)^(-sigma)'; 
'exp(k)'; 
'a'; 
...
save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Ejemplo_Dynare_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
